...
class SubscriptionErrorCode extends ApiErrors\ErrorCode
{
    ...
    const API_SUBSCRIPTION_PAUSE_FAILED        = 'Razorpay API subscription pause failed';
    const API_SUBSCRIPTION_RESUME_FAILED       = 'Razorpay API subscription resume failed';
